...
# Признаки по типу (сеть 2) — по «Маппинг признаков.md»
...
# Головы с бустингом редких классов — «Маппинг признаков.md», колонка «Используем Бустинг = да»
FEATURE_HEAD_MINORITY_BOOST: frozenset[str] = frozenset({
    "кельты:орнамент",
    "кельты:сохранность",
    "кельты:тулья",
    "накладки:крепление",
    "накладки:форма",
    "накладки:сохранность",
    "наконечники стрел:материал",
    "наконечники стрел:сохранность",
    "наконечники стрел:тип_насада",
    "наконечники стрел:форма_пера",
    "наконечники стрел:сечение",
    "ножи:материал",
    "ножи:тип",
    "ножи:рукоять",
    "удила:материал",
...
FEATURE_MINORITY_BOOST_FACTOR = 1.25
