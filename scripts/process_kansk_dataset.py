"""
Обработка датасета «Канск 2023» → data/dataset/
...
def extract_features(
    ...
    if class_name == "кельты":
        ...
        feats["тип_окончания"] = _first_match(
            desc,
            [
                ("подтреугольно-кольчат", "подтреугольно-кольчатое"),
                ("подтреугольно-кольчатым", "подтреугольно-кольчатое"),
                ("овально-кольчат", "овально-кольчатое"),
                ("кольцевидно-овальн", "кольцевидно-овальное"),
                ("трапециевидн", "трапециевидное"),
                ("подтреугольн", "подтреугольное"),
                ("стремечковидн", "стремечковидное"),
                ("кругл", "круглое"),
                ("овальн", "овальное"),
                ("кольчат", "кольчатое"),
                ("шарнирн", "шарнирные"),
        ...
        feats["шарнирность"] = _first_match(
            ...
            [
                ...
                ("в звеньях", "шарнирные"),
                ("в звенья", "шарнирные"),
                ("звенья удил", "шарнирные"),
                ("звено удил", "шарнирные"),
                ("отдельных звен", "шарнирные"),
            ],
        )

    elif class_name == "наконечники стрел":
        feats["тип_насада"] = _first_match(
            desc,
            [
                ("втульчат", "втульчатый"),
                ("черешков", "черешковый"),
        ...
        feats["форма"] = _first_match(
            desc,
            [
                ("четырехлепестков", "четырехлепестковая"),
                ("дисковидн", "дисковидная"),
                ("каплевидн", "каплевидная"),
                ("подовальн", "подовальная"),
                ("ажурн", "ажурная"),
                ("конусовидн", "конусовидная"),
                ("конус", "конусовидная"),
                ("двухчастн", "двухчастная"),
                ("кругл", "круглая"),
                ("бляшк", "круглая"),
                ("пуговиц", "круглая"),
                ("нашивк", "нашивка"),
